...
// interfaces
import { ICRMUser } from '../interfaces'; // Assuming you have the interface defined

const crmUserSchema: Schema<ICRMUser> = new Schema<ICRMUser>(
  {
...
const CRMUserModel: Model<ICRMUser> = mongoose.model<ICRMUser>('crm_user', crmUserSchema);

export default CRMUserModel;

export { crmUserSchema };
