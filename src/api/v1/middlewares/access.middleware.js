    ...
    try {
      ...
      if (
        ...
        if (token) {
          ...
          logger.info(
            "User which the request is being made for" + requestUserId
          );
          ...
          if (userId == requestUserId) {
            ...
            logger.info(
              "The user that is making the request is the same user that the request is being made for. Passed to next middleware"
            );
            ...
            if (user.company && requestUser.company) {
              ...
              if (
                ...
                // Pass the request to the next middleware
                logger.info(
                  "The user that made the request is an admin, company owner or company board member of the company that the request is being made for. Passed to next middleware"
                );
              ...
              logger.info(
                "User is not associated with a company. User is not allowed to access the requested user's information"
              );
