...
export default class NotificationsController {
  ...
  static async sendHomeCareOrderScheduleVisitNotification(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {}

  static async sendHomeCareOrderQuoteNotification(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      try {
        order = await NotificationsController.HomeCareOrdersDAO.queryOne({ _id: req.params.id }, [
          {
            path: 'patient',
            model: 'patient',
          },
      ...
      await NotificationsController.HomeCareOrdersDAO.update(order);
      ...
      let collaborators = (
        await NotificationsController.CollaboratorsDAO.queryList({
      ...
      await NotificationsController.SES.sendEmail(
  ...
  static async sendHomeCareOrderUpdateNotification(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {}
