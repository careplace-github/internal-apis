...
// functio to 
static initAWS (region = AWS_region, identityPoolId = AWS_identity_pool_id, userPoolId = AWS_user_pool_id, clientId = AWS_client_id, accessKeyId = AWS_access_key_id, secretAccessKey = AWS_secret_access_key, ) { 
