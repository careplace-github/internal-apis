...
// MongoDB collections
export const MONGODB_COLLECTION_CRM_USERS_NS = process.env
  .MONGODB_COLLECTION_CRM_USERS_NS as string;
export const MONGODB_COLLECTION_MARKETPLACE_USERS_NS = process.env
  .MONGODB_COLLECTION_MARKETPLACE_USERS_NS as string;
export const MONGODB_COLLECTION_COMPANIES_NS = process.env
  .MONGODB_COLLECTION_COMPANIES_NS as string;
export const MONGODB_COLLECTION_SERVICES_NS = process.env.MONGODB_COLLECTION_SERVICES_NS as string;
export const MONGODB_COLLECTION_ORDERS_NS = process.env.MONGODB_COLLECTION_ORDERS_NS as string;
...
export const MONGODB_COLLECTION_EVENTS_SERIES_NS = process.env
  .MONGODB_COLLECTION_EVENTS_SERIES_NS as string;
export const MONGODB_COLLECTION_RELATIVES_NS = process.env
  .MONGODB_COLLECTION_RELATIVES_NS as string;
export const MONGODB_COLLECTION_REVIEWS_NS = process.env.MONGODB_COLLECTION_REVIEWS_NS as string;
