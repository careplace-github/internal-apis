...
const EventSeriesSchema: Schema<IEventSeriesDocument> = new Schema<IEventSeriesDocument>(
  {
    _id: {
...
const EventSeriesModel: Model<IEventSeriesDocument> = mongoose.model<IEventSeriesDocument>(
  'EventSeries',
  EventSeriesSchema
);
