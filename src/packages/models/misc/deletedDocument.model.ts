...
const DeletedDocumentSchema: Schema<IDeletedDocumentDocument> =
  new Schema<IDeletedDocumentDocument>(
    {
      _id: {
...
const DeletedDocumentModel: Model<IDeletedDocumentDocument> =
  mongoose.model<IDeletedDocumentDocument>('deletedDocument', DeletedDocumentSchema);
